...
<!-- Services section 2
			...
			<div class="box-section services-section2 triggerAnimation animated" data-animate="rotateInUpLeft">
				<h1>OPERATIONS MANAGER</h1>
					...
					<div class="col-md-4">
						<div class="services-post">
							<div class="image-holder">
                                <img src="images/operations.jpeg" class="img-responsive img-circle" alt="Ngoni Seremwe">
                           </div>
							<h2>Cephas Makoni</h2>
					...
					<p style="color:white">Cephas Makoni is a supply chain management expert with over 15 years experience. He has worked for renowned organizations internationally and locally in uplifting business management processes. He is the author of Supply Chain Integration,a text book relevant for business and practioners desiring to strategically position themselves in any business environment. His passion is to see economies leveraging on supply chain management excellence. He holds a Bachelor of Commerce in Supply Chain and Operations Management(UNISA),Diploma Purchasing and Supply Management..</p>
