					...
					<div class="col-md-4">
						<div class="services-post">
							<div class="image-holder">
                                <img src="images/leader.jpg" class="img-responsive img-circle" alt="Farai fabright Mathende">
                           </div>
							<h2>Farai fabright Mathende</h2>
							
							
						</div>
					</div>
					
					<p style="color: white; font-size: 20px">Farai fabright Mathende is the founder and CEO of Appendix Inc. (PBC)  who is also the Team Leader of Oackscript Publishers Academy. He holds a 1st class degree in HRM from Great Zimbabwe University and was awarded four  (4) awards. He is also an author of Christian, motivational, leadership and entrepreneurship books.  Again, he is also into motivational speaking, couching/mentorship , counseling, leadership and entrepreneurship training. Contact: +263779263156</p>
