...
<!-- Services section 2
			...
			<div class="box-section services-section2 triggerAnimation animated" data-animate="rotateInUpLeft">
				<h1>About Us</h1>
                	<div class="row">
					<p style="color: white; font-size: 20px">Oakscript Publishers Academy is a Strategic Business Unit of Appendix Inc. registered in 2020. We offer services such as academic consulting and book publishing. Our academic consulting services include online tutoring,scholarships, counselling and mentorship We are also involved in book publishing and provide services such as printing and logo design.</p>

<p style="color: white; font-size: 20px">We are proudly a Zimbabwean company with highly qualified Tutors to support our academic consultancy platform.Each tutor is tasked with the responsibility of assisting students with academic assignments,journal and projects of any nature.</p>

<p style="color: white ; font-size: 20px">Our book publishing services is headed by qualified and experienced publishers who are themselves famous authors. The major responsibility of this development focuses on book printing,developing author writing skills,logo design and web design</p>
				...
				<div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
					...
					<div class="carousel-inner">
							    ...
							    <div class="row">
								    <div class="col-sm-3">
									    <div class="project-post">
										    <img src="images/c1.jpg" alt="GEC">
									    </div>
								    </div>
								    <div class="col-sm-3">
									    <div class="project-post">
										    <img src="images/c2.jpg" alt="GEC">	
									    </div>
								    </div>
								    <div class="col-sm-3">
									    <div class="project-post">
										    <img src="images/c3.jpg" alt="GEC">
									    </div>
								    </div>
								    <div class="col-sm-3">
									    <div class="project-post">
										    <img src="images/c4.jpg" alt="GEC">	
									    </div>
								    </div>
						        </div>
					            </div>
							...
							<div class="row">
								...
								<div class="col-sm-3">
									<div class="project-post">
										<img src="images/c7.jpg" alt="GEC">	
									</div>
								</div>
								<div class="col-sm-3">
									<div class="project-post">
										<img src="images/c8.jpg" alt="GEC">	
									</div>
								</div>
						    </div>
					        </div>
	 ...
	 <!-- footer section
			...
			<footer>
				...
				<div class="footer-line">
					<p><span>Copyright &copy; 2020 Site by N.SEREMWE</span></p>
