							    ...
							    <div class="row">
								    <div class="col-sm-3">
									    <div class="project-post">
                                            <h1>Team leader and founder</h1>
										    <img src="images/leader.jpg" alt="DAZ">	
                                            <a href="ourteam2.php">View Details</a>
									    </div>
								    </div>
								    <div class="col-sm-3">
									    <div class="project-post">
                                            <h1>IT MANAGER</h1>
										    <img src="images/it_manager.jpg" alt="NGONI SEREMWE">
                                            <a href="ourteam1.php">View Details</a>
									    </div>
								    </div>
								    <div class="col-sm-3">
									    <div class="project-post">
                                            <h1>OPERATIONS MANAGER</h1>
										    <img src="images/operations.jpeg" alt="Cephas Makoni">	
                                            <a href="ourteam3.php">View Details</a>
									    </div>
								    </div>
								    <div class="col-sm-3">
									    <div class="project-post">
                                            <h1>MARKETING MANAGER</h1>
										    <img src="images/marketing.jpeg" alt="oak">	
									    </div>
                                        <a href="ourteam4.php">View Details</a>
								    </div>
						        </div>
					            </div>
                                </div>
